...
# Default bootargs
setenv bootargs_default "rootfstype=ext4 rootwait ro loglevel=${verbosity} fsck.repair=yes 8250.nr_uarts=1 cgroup_enable=memory ${consoleargs}"
...
for BOOT_SLOT in "${BOOT_ORDER}"; do
  if test "x${raucargs}" != "xunset"; then
    ...
    if test ${BOOT_A_LEFT} -gt 0; then
      ...
      load mmc 0:5 ${kernel_addr_r} /boot/Image
    ...
    if test ${BOOT_B_LEFT} -gt 0; then
      ...
      load mmc 0:6 ${kernel_addr_r} /boot/Image
