...
define UNIPI_CONTROL_INSTALL_TARGET_CMDS
	...
	$(INSTALL) -D -m 0644 $(@D)/src/unipi_control/install/etc/unipi/control.yaml -t $(TARGET_DIR)/etc/unipi/control.yaml.example
	$(INSTALL) -D -m 0644 $(@D)/src/unipi_control/install/etc/unipi/hardware/neuron/L203.yaml -t $(TARGET_DIR)/etc/unipi/hardware/neuron/L203.yaml
	$(INSTALL) -D -m 0644 $(@D)/src/unipi_control/install/etc/unipi/hardware/extensions/Eastron_SDM120M.yaml -t $(TARGET_DIR)/etc/unipi/hardware/extensions/Eastron_SDM120M.yaml
endef
